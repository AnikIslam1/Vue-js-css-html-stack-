...
<nav class="navigation">
  ...
  <ul class="menu">
    <li><a class="active" href="http://localhost:8080/home/"><svg class="home" width="30px" height="30px" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml:space="preserve">
        ...
        </svg><span title="Home">Home</span></a></li>
    <li><a href="https://mail.google.com/mail/"><svg class="contact" width="30px" height="30px" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml:space="preserve">
        ...
        </svg><span title="Contact">Mail</span></a></li>
    <li><a href="https://codepen.io/anikislam1/full/yLbeKyM/"><svg class="lab" width="30px" height="30px" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml:space="preserve">
        ...
        </svg><span title="Lab">Game</span></a></li>
    <li><a href="#"><svg class="work" width="30px" height="30px" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml:space="preserve">
        ...
        </svg><span title="Work">Shopping</span></a></li>
    <li><a href="http://localhost:8080/"><svg class="about" width="30px" height="30px" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml:space="preserve">
        ...
        </svg><span title="About">Logout</span></a></li>
...
<section class="codepen-style">
  ...
  <h2>mail</h2>
  <p>Welcome <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="30px" height="30px" viewBox="0 0 512 512" enable-background="new 0 0 512 512" xml:space="preserve">
      <path id="favorite-6-icon" d="M256,462L53.676,284.644V130.646L169.034,50L256,104.977L342.965,50l115.359,80.646v153.998L256,462z M93.801,266.457L256,408.64l162.198-142.183V151.553l-76.35-53.375L256,152.447l-85.849-54.27l-76.351,53.375V266.457z" />
    </svg> by <a href="" target="_blank">Self Check</a></p>
  <div id="UserName_1"></div>
  <div id="UserMail">sss</div>
...
.navigation {
  ...
  width: 100%;
  display: block;
  box-shadow: #d4d4d4 -1px 1px, #d4d4d4 -2px 2px, #d4d4d4 -3px 3px,
    #d4d4d4 -4px 4px, #d4d4d4 -5px 5px, #d4d4d4 -6px 6px;
...
@media only screen and (min-width: 1024px) {
  ...
  .navigation a:hover {
    ...
    box-shadow: #303030 -1px 1px, #333 -2px 2px, #2e2e2e -3px 3px,
      #2b2b2b -4px 4px, #292929 -5px 5px, #262626 -6px 6px;
